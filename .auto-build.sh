...
function autobuild()
{
    ...
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ARM} ${BOARDS_ESP} examples/ErriezMicroseconds/ErriezMicroseconds.ino
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ARM} ${BOARDS_ESP} examples/ErriezMilliseconds/ErriezMilliseconds.ino
}
...
function generate_doxygen()
{
    ...
    DOXYGEN_PDF="ErriezTimestamp.pdf"
